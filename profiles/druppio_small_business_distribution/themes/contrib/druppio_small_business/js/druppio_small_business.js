...
$(function () {
  if($('.header.images .field__items').length){
...
jQuery(document).ready(function($){
  ...
  if (jQuery(".aa-blog-single").exists()) {
  equalheight('.aa-blog-single');
  }
  var firedcms =false;
  var firedskill = false;
  if (jQuery("#skill").exists()) {
  $(window).scroll(function() {
     var hT = $('#skill').offset().top,
         hH = $('#skill').outerHeight(),
         wH = $(window).height(),
         wS = $(this).scrollTop();
     if (wS > (hT+hH-wH) && firedskill == false){
      $('.dial').each(function () { 
  ...
  //Progress
  if (jQuery("#cms").exists()) {
  $(window).scroll(function() {
     var hT = $('#cms').offset().top,
         hH = $('#cms').outerHeight(),
         wH = $(window).height(),
         wS = $(this).scrollTop();
     if (wS > (hT+hH-wH) && firedcms == false){
